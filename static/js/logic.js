...
var earthquakeAllWeek = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson"
...
d3.json(earthquakeAllWeek).then(function(data) {
  ...
  }).addTo();  // use .addTo to add the L.geoJson object to the earthquakes LayerGroup
